...
function ChatBot1() {
    const steps = useMemo(
        () => [
            {
                id: "Greet",
                message: "Hello, Welcome to Career Bridge",
                trigger: "Ask Name",
            },
            {
                id: "Ask Name",
            ...
            },
            {
                id: "issues",
                options: [
                    { value: "Job Vacancies", label: "Job Vacancies", trigger: "Job Vacancies" },
            ...
            {
                id: "Job Vacancies",
                message: "You can view the latest job Vacancies across various domains at the top of the home page after signing in. Explore opportunities in your field and apply directly.",
                trigger: "Ask More",
            },
            {
                id: "Mock Test",
